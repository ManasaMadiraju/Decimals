...
//                 return Column(
//                   children: [
//                     _buildColoredNumber(number, colors[colorIndex],screenWidth),
...
//   Widget _buildColoredNumber(String number, Color color, double screenWidth) {
//     return Text(
//       number,
//       style: TextStyle(
//         fontSize: screenWidth>1200?40:20,
//         fontWeight: FontWeight.bold,
//         color: color,
//       ),
//     );
        ...
        children: [
          ...
          Row(
            ...
            children: questions[currentQuestionIndex].keys.map((number) {
              int colorIndex = questions[currentQuestionIndex].keys.toList().indexOf(number) % colors.length;
              return Column(
                children: [
